...
output2_folder = r'C:\Users\Utilisateur\Desktop\finale\POMPES0\output_license_plates'
output1_folder = r'C:\Users\Utilisateur\Desktop\finale\POMPES0\output_cars'
    ...
    def set_args(
        ...
        if len(reg_pts) == 2:
           ...
           # print("Region Counter Initiated.")
            ...
            #("Invalid Region points provided, region_points can be 2 or 4")
              ...
              if car_id != -1:
                  ...
                  if license_plate_text is not None:
                     if valider_plaque(license_plate_text):
                          ...
                          # Dessiner la boîte autour de la plaque
                        cv2.rectangle(self.im0, (int(x1), int(y1)), (int(x2), int(y2)), (0, 0, 255), 2)
                        ...
                        rect_y1 = text_y - text_size[1] - 2
                        rect_y2 = text_y + 2

                        # Dessiner le rectangle de fond
                        cv2.rectangle(self.im0, (rect_x1, rect_y1), (rect_x2, rect_y2), (0, 0, 255), cv2.FILLED)

                        # Dessiner le texte sur l'image
                        cv2.putText(self.im0, text, (text_x, text_y), font, font_scale, (255, 255, 255), thickness)
...
##########  PARTIE COMPTAGE
        ...
        self.combined_dict = combine_dicts(self.LP_info_dict, self.infos_vehicules)
        #print(combined_dict)
